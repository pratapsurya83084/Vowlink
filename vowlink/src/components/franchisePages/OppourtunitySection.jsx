...
const OpportunitySection = () => {
  return (
    <div className="text-white flex flex-col items-center px-10 py-8">
      ...
      {/* Point 1 */}
      <div className="bg-white  transition-transform transform hover:scale-105 p-6 rounded-lg shadow-lg">
        yet to be add icon
        <h2 className="text-2xl font-semibold mb-2  mt-4">Innovative Learning</h2>
        <p>Cutting-edge teaching methods and technologies for a successful future.</p>
      </div>

      {/* Point 2 */}
      <div className="bg-white p-6 transition-transform transform hover:scale-105 rounded-lg shadow-lg">
      yet to be add icon
        <h2 className="text-2xl font-semibold mb-2  mt-4">Supportive Community</h2>
        <p>A collaborative environment that drives academic excellence.</p>
      </div>
      ...
      yet to be add icon
        ...
        <p>Education initiatives crucial for long-term societal development.</p>
      </div>

      {/* Point 4 */}
      <div className="bg-white p-6  transition-transform transform hover:scale-105 h-52  rounded-lg shadow-lg">
      yet to be add icon
        <h2 className="text-2xl font-semibold mb-2 mt-4">Adaptive Support</h2>
        <p>Flexible support systems for a resilient and dynamic learning experience.</p>
      </div>
    </div>
    </div>
  );
