...
const TwoButtons = () => {
  return (
    <div className='flex flex-col items-center bg-gradient-to-r from-teal-400 to-teal-600 mt-20 mx-4 lg:mx-20 mb-20 py-12 px-6 rounded-lg shadow-2xl'>
      <p className='text-center text-white text-2xl lg:text-3xl font-bold px-4 mb-8'>
        "At VL, we aim to tailor tomorrow’s global leaders and visionaries <br />
        through our expert-designed courses and tools.”
      </p>
      {/* 2 buttons */}
