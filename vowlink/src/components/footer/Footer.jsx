...
const Footer = () => {
  ...
  return (
    <footer className="font-jost px-10  bg-gray-50 text-gray-600 py-12">
              ...
              <ul className="space-y-4">
                ...
                <li>
                  <a
                    ...
                    className="text-gray-600 hover:text-cyan-500 whitespace-nowrap"
                  >
                    Learn Portal
                  </a>
                </li>
              ...
              <ul className="space-y-4 ">
                <li>
                  <a
                    ...
                    className="text-gray-600hover:text-cyan-500"
                  >
                    Franchise
                  </a>
                </li>
      ...
      <footer className="font-type block lg:hidden  p-6">
        <div className="container mx-auto ">
          ...
          {/* add  startupindia logo*/}
          <div className="flex justify-center items-center w-full mt-10 hover-zoom">
            <img
              src="\startupIndia_vowlink_logo.png"
              alt="Logo"
